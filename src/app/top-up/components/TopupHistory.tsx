...
/**
 * Top-up transaction history component.
 * 
 * Currently shows empty state — no mock data generated.
 * Wire up fetchTopupHistory() from services/topup.ts when real API is available.
 * 
 * Expected data shape when API is ready:
 * { id, cardType, denomination, status: 'PENDING'|'SUCCESS'|'FAILED', createdAt, message }
 */
